...
ARG hive_pkg_url=https://mirrors.tuna.tsinghua.edu.cn/apache/hive/hive-${hive_version}/apache-hive-${hive_version}-bin.tar.gz
...
RUN echo "sh ${hive_scripts_home}/init-hive.sh && hivestart" >> /init_service
